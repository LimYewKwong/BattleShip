    ...
    public static void DrawDeployment()
    {
        ...
        foreach (ShipName sn in Enum.GetValues(typeof(ShipName)))
        {
            ...
            if (i >= 0)
            {
                ...
                //SwinGame.DrawText(sn.ToString(), Color.Black, GameFont("Premier"), SHIPS_LEFT + TEXT_OFFSET, SHIPS_TOP + i * SHIPS_HEIGHT)
        ...
        if (GameController.HumanPlayer.ReadyToDeploy)
        {
            ...
            //SwinGame.DrawText("PLAY", Color.Black, GameFont("Premier"), PLAY_BUTTON_LEFT + TEXT_OFFSET, PLAY_BUTTON_TOP)
        }
