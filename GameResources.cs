...
public static class GameResources
{
    ...
    {
		NewFont("TimesLarge", "times.ttf", 80, FontStyle.NormalFont);
		NewFont("MavenPro", "mavenpro.ttf", 16, FontStyle.BoldFont);
        NewFont("MavenProSmall", "mavenpro.ttf", 8, FontStyle.BoldFont);
		NewFont("Menu", "ffaccess.ttf", 12, FontStyle.NormalFont);
		NewFont ("Scoreboard", "scoreboard.ttf", 20, FontStyle.NormalFont);
    }
